...
```javascript
whileEachRight = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-while-each-right@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/utils-while-each-right/tags). For example,

```javascript
whileEachRight = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-while-each-right@v0.2.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var whileEachRight = require( 'path/to/vendor/umd/utils-while-each-right/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/utils-while-each-right@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/utils-while-each-right.svg
[npm-url]: https://npmjs.org/package/@stdlib/utils-while-each-right

[test-image]: https://github.com/stdlib-js/utils-while-each-right/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/utils-while-each-right/actions/workflows/test.yml?query=branch:v0.2.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/utils-while-each-right/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/utils-while-each-right?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/utils-while-each-right.svg
[dependencies-url]: https://david-dm.org/stdlib-js/utils-while-each-right/main
...
[deno-readme]: https://github.com/stdlib-js/utils-while-each-right/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/utils-while-each-right/tree/umd
[umd-readme]: https://github.com/stdlib-js/utils-while-each-right/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/utils-while-each-right/tree/esm
[esm-readme]: https://github.com/stdlib-js/utils-while-each-right/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/utils-while-each-right/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/utils-while-each-right/main/LICENSE
